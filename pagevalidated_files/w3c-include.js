(function () {
    ...
    function addValidatorSuite() {

        var vs_div = document.createElement("div");
        vs_div.setAttribute("class", "w3c-include");
        vs_div.setAttribute("id", "w3c-include-vs");
        w3c_include.appendChild(vs_div);

        vs_div.innerHTML =
            '<p>' +
                '<a href="https://validator-suite.w3.org/" title="Check your website with the W3C Validator Suite" class="w3c-include-vs-logo">' +
                    '<img src="https://validator-suite.w3.org/icons/vs-blue-256.png" alt="W3C Validator Suite" height="60">' +
                '</a>' +
            '</p>' +
            '<p>' +
                '<a href="https://validator-suite.w3.org/">Try now the W3C Validator Suite&trade;</a> premium service that checks your entire website and evaluates its conformance with W3C open standards to quickly identify those portions of your website that need your attention.' +
            '</p>';
